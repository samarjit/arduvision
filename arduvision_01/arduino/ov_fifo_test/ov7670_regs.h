...
const struct regval_list qvga_yuv_ov7670[] PROGMEM = {
     {OV7670_REG_COM8, COM8_FASTAEC|COM8_AECSTEP|COM8_AGC|COM8_AEC|COM8_AWB },
//     {OV7670_REG_COM8, COM8_AEC|COM8_AWB },
//          {OV7670_REG_CLKRC, CLKRC_4}, // 30fps (with 12MHz XCLK)
    //  {OV7670_REG_DBLV, DBLV_X8},  // 30fps (with 12MHz XCLK)
...
//      {OV7670_REG_VREF, 0x0a},
      ...
      {OV7670_REG_COM14, COM14_DCWEN | COM14_PCLK_DIV_2 }, // divide by 2
      {OV7670_REG_SCALING_DCWCTR, SCALING_DCWCTR_2}, // downsample by 2  ok
      {OV7670_REG_COM3, COM3_DCWEN}, // DCW enable, Scale enabled  ok
      {OV7670_REG_SCALING_PCLK_DIV,  0xf1 }, // SCALING_PCLK_DIV_2  xx divide by 2
...
const struct regval_list vga_yuv_ov7670[] PROGMEM = {
        ...
        {OV7670_REG_COM15, 0xC0},       // Set normal rgb with Full range
        {0x70, 0x3A},                   // Scaling Xsc
        {0x71, 0x35},
        {0xA2, 0x02},
        {OV7670_REG_CLKRC, 0x01},     
        {OV7670_REG_TSLB,  0x0D},    
        {OV7670_REG_COM7, 0x00},        //0x01 for RGB
        {OV7670_REG_DBLV, 0x4a}, 
        //{OV7670_REG_COM3, 0x04},        
        {OV7670_REG_COM14, 0},  //No scaling
        ...
        {OV7670_REG_VSTOP, 0x7a},    
        {OV7670_REG_VREF, 0x0a},
        {OV7670_REG_SCALING_DCWCTR, 0x11},         //0x72
        {OV7670_REG_SCALING_PCLK_DIV, 0xf0},      //0x73
...
const struct regval_list yvga_yuv_ov7670[] PROGMEM = {
        {OV7670_REG_COM8, COM8_FASTAEC|COM8_AECSTEP|COM8_BFILT|COM8_AGC|COM8_AEC}, 
        {OV7670_REG_COM17, 0x00},      //AEC DSP color bar not set
        {OV7670_REG_COM15, 0xC0},       // Set normal rgb with Full range
        {OV7670_REG_SCALING_XSC, 0x4A},                   // Scaling Xsc
        {OV7670_REG_SCALING_YSC, 0x35},
//        {OV7670_REG_SCALING_PCLK_DELAY, 0x01},
//        {OV7670_REG_CLKRC, 0x01},       //01 internal clock / 2
//        {OV7670_REG_TSLB,  0x0D},    
        {OV7670_REG_COM7, 0x00},        //0x01 for RGB
...
//        {OV7670_REG_SCALING_PCLK_DIV, 0xf0},      //0x73
      ...
      // 640x240
//      {OV7670_REG_COM14, 0x0}, // divide by 4
      {0x72, 0x11}, // downsample by 0
      {0x73, 0xf0}, // divide by 0

    {OV7670_REG_SATCTR, 0x60},
